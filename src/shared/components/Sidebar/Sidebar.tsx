      ...
      <div className="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
        ...
        <div className="overflow-x-hidden flex-grow">
          <Menu>
            ...
            <ItemMenu icon={<MenuBookOutlinedIcon />} route="catalago">
              Catálogo
            </ItemMenu>
            ...
            <ItemMenu icon={<Inventory2OutlinedIcon />} route="">
              Estoque
            </ItemMenu>
            ...
            <ItemMenu icon={<SettingsOutlinedIcon />} route="">
              Configurações
            </ItemMenu>
            <ItemMenu icon={<LogoutOutlinedIcon />} route="">
